...
function(a) {
    ...
    h = function() {
        ...
        s = function(a, b) {
            ...
            function d(e) {
                a !== e && b(e) && c.push(e);
                for (var f = 0,
                g = e.childNodes.length; g > f; f++) d(e.childNodes[f])
            } (a),
            c
        },
        t = function(b, c) {
        ...
        w = i("#text"),
        x = function(a) {
            return h.isText(a) && b(a.parentNode)
        },
        y = function(a) {
            return w(a) ? a.nodeValue.length: a.childNodes.length
        },
        z = function(a) {
            return 0 === a.offset || a.offset === y(a.node)
        },
        A = function(a) {
        ...
        F = function(a, b) {
            if (0 === b) return a;
            if (b >= y(a)) return a.nextSibling;
            if (w(a)) return a.splitText(b);
            var c = a.childNodes[b];
            return a = u(a.cloneNode(!1), a),
            v(a, r(c))
        },
        G = function(a, b, c) {
            var d = n(b, f.eq(a));
            return 1 === d.length ? F(b, c) : d.reduce(function(a, d) {
                var e = d.cloneNode(!1);
                return u(e, d),
                a === b && (a = F(a, c)),
                v(e, r(a)),
    ...
    l = function() {
        ...
        this.current = function(c, d) {
            ...
            return g.image = h.isImg(d) && d,
            g.anchor = c.isOnAnchor() && h.ancestor(c.sc, h.isAnchor),
            g.aAncestor = h.listAncestor(c.sc, h.isEditable),
            g.range = c,
            g
        }
    },
    m = function() {
        ...
        c = function(a, b) {
            ...
            for (c = 0; c < i.length; c++) if (!h.isText(i[c])) {
            ...
            if (0 !== c && h.isText(i[c - 1])) {
                ...
                k = null;
                j.moveToElementText(d || e),
                j.collapse(!d),
                k = d ? d.nextSibling: e.firstChild;
                var l = a.duplicate();
                ...
                b && k.nextSibling && h.isText(k.nextSibling) && m === k.nodeValue.length && (m -= k.nodeValue.length, k = k.nextSibling),
                e = k,
                c = m
            }
            return {
        ...
        d = function(a) {
            var b = function(a, c) {
                ...
                if (h.isText(a)) {
                    ...
                    d = j || a.parentNode,
                    c += g.sum(g.tail(i), h.length),
                    e = !j
                } else {
                    if (d = a.childNodes[c] || a, h.isText(d)) return b(d, 0);
                    c = 0,
                    e = !1
                }
                return {
            ...
            d = b(a.cont, a.offset);
            return c.moveToElementText(d.cont),
        ...
        e = function(c, i, j, k) {
            ...
            this.expand = function(a) {
                ...
                var f = this.getBPs();
                return b && (f.sc = b, f.so = 0),
                d && (f.ec = d, f.eo = h.length(d)),
                new e(f.sc, f.so, f.ec, f.eo)
            },
            ...
            this.splitText = function() {
                var a = c === j,
                b = this.getBPs();
                return h.isText(j) && !h.isEdgeBP(this.getEndBP()) && j.splitText(k),
                h.isText(c) && !h.isEdgeBP(this.getStartBP()) && (b.sc = c.splitText(i), b.so = 0, a && (b.ec = b.sc, b.eo = k - i)),
                new e(b.sc, b.so, b.ec, b.eo)
            },
            this.deleteContents = function() {
                if (this.isCollapsed()) return this;
                var b = this.splitText(),
                c = h.prevBP(b.getStartBP());
                return a.each(b.nodes(),
                function(a, b) {
            ...
            this.isOnEditable = m(h.isEditable),
            this.isOnList = m(h.isList),
            this.isOnAnchor = m(h.isAnchor),
            this.isOnCell = m(h.isCell),
    ...
    o = function() {
        ...
        this.fontSize = function(a, b) {
            ...
            e.isFF ? a.find("font[size=3]").removeAttr("size").css("font-size", b + "px") : a.find("span").filter(function() {
                return "medium" === this.style.fontSize
            }).css("font-size", b + "px")
        },
        this.lineHeight = function(a, c) {
            d(a),
            b.stylePara(m.create(), {
                lineHeight: c
            })
        },
    ...
    p = function() {
        ...
        d = function(a, b) {
            ...
            m.createFromBookmark(a[0], b.bookmark).select()
        };
    ...
    q = function() {
        this.update = function(b, c) {
            ...
            e('button[data-event="bold"]',
            function() {
                return "bold" === c["font-bold"]
            }),
            e('button[data-event="italic"]',
            function() {
                return "italic" === c["font-italic"]
            }),
            e('button[data-event="underline"]',
            function() {
                return "underline" === c["font-underline"]
            }),
            e('button[data-event="strikethrough"]',
            function() {
                return "strikethrough" === c["font-strikethrough"]
            }),
            e('button[data-event="superscript"]',
            function() {
                return "superscript" === c["font-superscript"]
            }),
            e('button[data-event="subscript"]',
            function() {
                return "subscript" === c["font-subscript"]
            }),
            e('button[data-event="justifyLeft"]',
            function() {
                return "left" === c["text-align"] || "start" === c["text-align"]
            }),
            e('button[data-event="justifyCenter"]',
            function() {
                return "center" === c["text-align"]
            }),
            e('button[data-event="justifyRight"]',
            function() {
                return "right" === c["text-align"]
            }),
            e('button[data-event="justifyFull"]',
            function() {
                return "justify" === c["text-align"]
            }),
            e('button[data-event="insertUnorderedList"]',
            function() {
                return "unordered" === c["list-style"]
            }),
            e('button[data-event="insertOrderedList"]',
            function() {
        ...
        this.showImageDialog = function(c, d) {
            return a.Deferred(function(a) {
                ...
                function() {
                    ...
                    function(a) {
                        var c;
                        c = "paste" === a.type ? a.originalEvent.clipboardData.getData("text") : f.val(),
                        b(g, c)
                    }).val("").trigger("focus")
                }).one("hidden.bs.modal",
                function() {
        ...
        this.showLinkDialog = function(c, d, e) {
            return a.Deferred(function(a) {
                ...
                function() {
                    ...
                    e.url || (e.url = e.text, b(h, e.text)),
                    g.keyup(function() {
                        b(h, g.val()),
                        e.text || f.val(g.val())
                    }).val(e.url).trigger("focus").trigger("select"),
                    i.prop("checked", e.newWindow),
                    h.one("click",
                    function(b) {
                        b.preventDefault(),
                        a.resolve({
    ...
    e.hasCodeMirror && (e.isSupportAmd ? require(["CodeMirror"],
    function(a) {
        b = a
    }) : b = window.CodeMirror);
    var v = function() {
        ...
        v = function(b) {
            ...
            var d;
            return d = c.is(".note-editor, .note-air-editor") ? c: a("#note-editor-" + g.last(c.attr("id").split("-"))),
            h.buildLayoutInfo(d)
        },
        w = function(b, c) {
            i.restoreRange(b);
            var d = b.data("callbacks");
            d.onImageUpload ? d.onImageUpload(c, i, b) : a.each(c,
            function(a, c) {
        ...
        x = {
            showLinkDialog: function(a) {
                ...
                f = b.data("options");
                i.saveRange(d),
                q.showLinkDialog(d, c, e).then(function(b) {
                    i.restoreRange(d),
                    i.createLink(d, b, f),
                    m.hide(a.popover())
                }).fail(function() {
            ...
            showImageDialog: function(a) {
                ...
                c = a.editable();
                i.saveRange(c),
                q.showImageDialog(c, b).then(function(a) {
                    i.restoreRange(c),
                    "string" == typeof a ? i.insertImage(c, a) : w(c, a)
                }).fail(function() {
                    i.restoreRange(c)
                })
            },
            showVideoDialog: function(a) {
                ...
                d = i.getVideoInfo(c);
                i.saveRange(c),
                q.showVideoDialog(c, b, d).then(function(a) {
                    i.restoreRange(c),
                    i.insertVideo(c, a)
                }).fail(function() {
                    i.restoreRange(c)
            ...
            showHelpDialog: function(a) {
                ...
                c = a.editable();
                i.saveRange(c),
                q.showHelpDialog(c, b).then(function() {
                    i.restoreRange(c)
                })
            },
            fullscreen: function(a) {
                ...
                j ? (e.data("orgheight", e.css("height")), c.on("resize",
                function() {
                    i({
                        w: c.width(),
            ...
            codeview: function(a) {
                ...
                o ? (j.val(i.html()), j.height(i.height()), l.deactivate(g), m.hide(k), j.focus(), e.hasCodeMirror && (c = b.fromTextArea(j[0], n.codemirror), n.codemirror.tern && (d = new b.TernServer(n.codemirror.tern), c.ternServer = d, c.on("cursorActivity",
                function(a) {
                    d.updateArgHints(a)
                ...
                }), j.data("cmEditor", c))) : (e.hasCodeMirror && (c = j.data("cmEditor"), j.val(c.getValue()), c.toTextArea()), i.html(j.val() || h.emptyPara), i.height(n.height ? j.height() : "auto"), l.activate(g), i.focus()),
                l.updateCodeview(a.toolbar(), o)
            }
        },
        y = function(a) {
        ...
        z = function(a) {
            setTimeout(function() {
                ...
                if (c) {
                    ...
                    d || l.update(b.toolbar(), c),
                    m.update(b.popover(), c, d),
        ...
        G = function(a) {
            ...
            function(a) {
                var d = a.clientY - (c + F);
                d = f.minHeight > 0 ? Math.max(d, f.minHeight) : d,
                d = f.maxHeight > 0 ? Math.min(d, f.maxHeight) : d,
                b.height(d)
            }).one("mouseup",
            function() {
                d.off("mousemove")
        ...
        J = function(b) {
            ...
            function(a) {
                ...
                d || c.length || (b.editor.addClass("dragover"), e.width(b.editor.width()), e.height(b.editor.height()), f.text("Drag Image Here")),
                c = c.add(a.target)
            }).on("dragleave",
            function(a) {
                c = c.not(a.target),
                c.length || b.editor.removeClass("dragover")
            }).on("drop",
            function() {
                c = a(),
        ...
        this.bindKeyMap = function(a, b) {
            ...
            function(e) {
                var f = [];
                e.metaKey && f.push("CMD"),
                e.ctrlKey && !e.altKey && f.push("CTRL"),
                e.shiftKey && f.push("SHIFT");
        ...
        this.attach = function(a, b) {
            this.bindKeyMap(a, b.keyMap[e.isMac ? "mac": "pc"]),
            a.editable.on("mousedown", y),
            a.editable.on("keyup mouseup", z),
            a.editable.on("scroll", A),
            a.editable.on("paste", B),
            a.handle.on("mousedown", C),
            a.popover.on("click", E),
            a.popover.on("mousedown", D),
            b.airMode || (b.disableDragAndDrop || J(a), a.toolbar.on("click", E), a.toolbar.on("mousedown", D), b.disableResizeEditor || a.statusbar.on("mousedown", G));
            ...
            }), b.onfocus && a.editable.focus(b.onfocus), b.onblur && a.editable.blur(b.onblur), b.onkeyup && a.editable.keyup(b.onkeyup), b.onkeydown && a.editable.keydown(b.onkeydown), b.onpaste && a.editable.on("paste", b.onpaste), b.showImageDialog && (x.showImageDialog = b.showImageDialog), b.onToolbarClick && a.toolbar.click(b.onToolbarClick), b.onChange) {
                var f = function() {
    ...
    w = function() {
        ...
        j = function(a, e) {
            ...
            h = function() {
                for (var b = "",
                c = 0,
                f = e.airPopover.length; f > c; c++) {
                    var g = e.airPopover[c];
                    b += '<div class="note-' + g[0] + ' btn-group">';
                    for (var h = 0,
                    j = g[1].length; j > h; h++) b += i[g[1][h]](a, e);
                    b += "</div>"
                }
        ...
        r = function(a, b) {
            ...
            return b.extraKeys && (c += '<tr><td colspan="2">' + q(a, b) + "</td></tr>"),
            c += "</tbody</table>"
        },
        s = function(a) {
        ...
        v = function(a) {
            return e.isMac && (a = a.replace("CMD", "⌘").replace("SHIFT", "⇧")),
        ...
        this.createLayoutByAirMode = function(b, c) {
            ...
            x(l, c);
            var m = a(k());
            m.addClass("note-air-layout"),
            m.attr("id", "note-handle-" + h),
            m.appendTo(i);
            var n = a(t(g, c));
            n.addClass("note-air-layout"),
            n.attr("id", "note-dialog-" + h),
            n.find("button.close, a.modal-close").click(function() {
        ...
        this.createLayoutByFrame = function(b, c) {
            ...
            c.height > 0 && a('<div class="note-statusbar">' + (c.disableResizeEditor ? "": u()) + "</div>").prependTo(d);
            var f = !b.is(":disabled"),
            g = a('<div class="note-editable" contentEditable="' + f + '"></div>').prependTo(d);
            c.height && g.height(c.height),
            c.direction && g.attr("dir", c.direction),
            g.html(h.html(b) || h.emptyPara),
            a('<textarea class="note-codable"></textarea>').prependTo(d);
            for (var l = a.summernote.lang[c.lang], m = "", n = 0, o = c.toolbar.length; o > n; n++) {
                var p = c.toolbar[n][0],
                q = c.toolbar[n][1];
                m += '<div class="note-' + p + ' btn-group">';
                for (var r = 0,
                s = q.length; s > r; r++) a.isFunction(i[q[r]]) && (m += i[q[r]](l, c));
                m += "</div>"
            }
            ...
            a('<div class="note-dropzone"><div class="note-dropzone-message"></div></div>').prependTo(d),
            d.insertAfter(b),
            b.hide()
        },
    ...
    a.fn.extend({
        summernote: function(b) {
            ...
            a.summernote.options, b), this.each(function(c, d) {
                ...
                y.attach(f, b),
                h.isTextarea(e[0]) && e.closest("form").submit(function() {
                    e.val(e.code())
                })
            ...
            return this.length && b.oninit && b.oninit(),
            this
        },
        code: function(b) {
            if (void 0 === b) {
                ...
                if (d && d.editable) {
                    ...
                    return f && e.hasCodeMirror && d.codable.data("cmEditor").save(),
