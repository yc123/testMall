(function($){$.fn.imagezoom=function(options){var settings={xzoom:310,yzoom:240,offset:10,position:"BTR",preload:1};if(options){$.extend(settings,options);}
