...
var config = {
  scope: _parchment2.default.Scope.INLINE,
  whitelist: ['serif', 'monospace', 'Microsoft_YaHei']
};
...
var SizeClass = new _parchment2.default.Attributor.Class('size', 'ql-size', {
  scope: _parchment2.default.Scope.INLINE,
  whitelist: ['12', '14', '15', '16']
});
var SizeStyle = new _parchment2.default.Attributor.Style('size', 'font-size', {
  scope: _parchment2.default.Scope.INLINE,
  whitelist: ['12px', '14px', '15px', '16px']
});
...
var FONTS = [false, 'serif', 'monospace', 'Microsoft_YaHei'];

var HEADERS = ['1', '2', '3', false];

var SIZES = ['12', false, '14', '15', '16'];
...
SnowTooltip.TEMPLATE = ['<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join('');
