define([ 'app/app' ], function(app) {
	//订单详情
	app.register.controller('ChangeFromCustDetailCtrl', ['$scope', '$stateParams', 'Change', 'toaster', '$modal', function($scope, $stateParams, Change, toaster, $modal) {
		Change.getFCAdmin({changeid : $stateParams.changeid}, function(data) {
			$scope.changeFC = data;
			$scope.info = {};
			...
			var scheduleStyle = function(){ 
				var statusAttr =['311', '409', '103', '410', '407', '404'];
